...
if input_list[0].lower() == "rewards" or input_list[0].lower() == "reward": #no pdf ta escrito dos dois jeitos
    client = 1
else:
    client = 0
...
hotels = {
    "Lakewood": [110, 80, 90, 80, 3],
    "Bridgewood": [160, 110, 60, 50, 4],
    "Ridgewood": [220, 100, 150, 40, 5]
}
...
print(result)
print("--------------------------------------------------")
if result[0][2] == result[1][2] == result[2][2]: ## TESTAAAAR
